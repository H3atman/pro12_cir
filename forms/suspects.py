...
def SuspectDetails(mps_cps, ppo_cpo, pro, index):
    ...
    with st.container(border=True):
        ...
        with col21:
            status_list = ["Acquitted", "Arrested", "At-Large", "Deceased", "Detained", "Escaped", "Hospitalized", "Killed", "Neutralized", "On-Bail", "On-Probation", "Released", "Serving Sentence", "Turned-over to Barangay", "Turned-over to Family", "Turned-over to Hospital", "Turned-over to other unit", "Turned-over to Rehabilitation Center", "Turned-over to School", "Turned-over to Shelter (GO/DSWD)", "Turned-over to Shelter (GO/LSWD)", "Turned-over to Shelter (NGO)", "Voluntarily Surrendered", "Wounded"]
